...
Beacon::Beacon(const char *name, short kind) : ::omnetpp::cPacket(name, kind)
{
}

Beacon::Beacon(const Beacon& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
const omnetpp::cModule * Beacon::getSrc() const
{
    return this->src;
}

void Beacon::setSrc(omnetpp::cModule * src)
{
    this->src = src;
}

const omnetpp::cModule * Beacon::getDst() const
{
    return this->dst;
}

void Beacon::setDst(omnetpp::cModule * dst)
{
    this->dst = dst;
}
...
BeaconDescriptor::BeaconDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(Beacon)), "omnetpp::cPacket")
{
